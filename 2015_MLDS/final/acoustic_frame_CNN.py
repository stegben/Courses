...
from keras.layers.core import Dense, Activation, Dropout, Flatten, MaxoutDense
...
try:
  for i in range(epoch):
    model.fit(X,Y , batch_size = 64,nb_epoch=1,shuffle=True,validation_split=0.0,show_accuracy=False)

...
model.add(MaxoutDense(2048,1024,nb_feature=8))
model.add(Dropout(0.5))

model.add(Dense(1024,2048,activation='linear'))
model.add(PReLU(2048))
model.add(Dropout(0.5))
...
new_X_cv = convolvArray(prob,6,6) 
...
new_X_test = convolvArray(prob_test,6,6)
